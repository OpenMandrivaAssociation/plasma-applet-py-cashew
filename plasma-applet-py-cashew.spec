...
%description
Py-Cashew is a KDE4 plasmoid that hides the desktop toolbox, also known as the cashew.
Some find the cashew pretty but others who don't have no way to remove it. The KDE
developers made it clear that they won't add an option to hide it (see
http://userbase.kde.org/Plasma/FAQ/4.4#Please_provide_an_option_to_disable_the_upper_right_cashew.),
so this plasmoid offers a way out.
